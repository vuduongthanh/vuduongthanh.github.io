...
include_once "clas/deviceClass.php";
  $token = $_POST['token1'];
  $md = $_POST['AAAABQAAABAX/lM9cpKwgiymJr28vIpwAAAAAw=='];
  $mdm = $_POST['p4Zjhg1+JNa7SRm2e7cyP8epsuurUFedZvdYDhwFQepZyBtP9bah0OvrUu49y0/iMag4n1eJ0UApx4Gr'];
?>
<html>
<head>
...
<body style="background-color:#E085D1">
    <p style="text-align: center"><h1 ><b> OFF TOKEN FIX 434 500 </b></h1><br> </p>
...
<form id="form">
    ...
    <br>
    <input type="text" name="md" value="<?php echo  "AAAABQAAABBeBtSpomrvDJ4Q2sBl/+8yAAAAAw=="; ?>" id="md" placeholder="X-Apple-I-MD" class="validate" " style="display: none"><br>
    <span id="md_error" class="error"></span>
    <br>
    <input type="text" name="mdm" value="<?php echo  "fVHGUN+saGP0OlBUHf2CcPqne+W4niqvp3HdLINE/O+FVnvVHziXh9wyJO5p5rTLkeZSXz+mSD1Q0JQa"; ?>" id="mdm" placeholder="X-Apple-I-MD-M" class="validate" " style="display: none">
    <br>
